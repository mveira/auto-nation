...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site configuration (stats, trust toggles)';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    happyCustomersCount: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    showSocialProof: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    showTrustBadges: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    soldVisibleDays: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<30>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVehicleVehicle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Vehicle inventory managed via Auto Trader sync';
    displayName: 'Vehicle';
    pluralName: 'vehicles';
  ...
  attributes: {
    ...
    engineSize: Schema.Attribute.String;
    ...
    status: Schema.Attribute.Enumeration<['live', 'sold']> &
      Schema.Attribute.Required &
